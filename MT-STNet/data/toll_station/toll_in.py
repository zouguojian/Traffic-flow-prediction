...
keys=['entry_station','tian','xiaoshi','fenzhong','cheliuliang'] # keys
...
def read_source(file_paths, beg_month=6,end_month=9,year=2021,encoding='utf-8'):
    ...
    for in_toll_station in in_toll_stations:
        ...
        for in_file_path in file_paths:
            ...
            in_toll_station_data_list.append(in_toll_station_data.loc[(in_toll_station_data['entry_station'] == in_toll_station)])
            ...
            for day in range(1, months[month]+1):
                ...
                for hour in range(hours):
                    for minute in range(0, minutes, 5):
                        ...
                        print(in_toll_station, current_date,day,hour,minute,sum_flow)
                        yield in_toll_station, current_date,day,hour,minute,sum_flow
