...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/yinchuan/GMAN', help='save path')
        self.parser.add_argument('--model_name', type=str, default='GMAN', help='training or testing model name')
        self.parser.add_argument('--file_train_f', type=str, default='data/yinchuan/train.csv', help='training_speed file address')
        ...
        self.parser.add_argument('--num_blocks', type=int, default=5, help='total number of attention layers')
        self.parser.add_argument('--predict_steps', type=int, default=12, help='move steps in prediction')
