...
DEVICE = 'cuda:2'
MODEL = 'RGSL'
DATASET = 'data/YINCHUAN'
GRAPH = "data/YINCHUAN/adjacent.npz"
FILENAME_ID = None

# 1. get configuration
config_file = '{}_{}.conf'.format(DATASET.split('/')[-1], MODEL)
...
args.add_argument('--log_dir', default='data/', type=str)
args.add_argument('--model_ema_decay', type=float, default=0.999,
