...
def main(runid):
    ...
    if not os.path.exists(args.save):
        ...
        print('create params directory %s' % (args.save))
    ...
    for i in range(1,args.epochs+1):
        ...
        if mvalid_loss < minl:
            print('Val loss decrease from {:.3f} to {:.3f}, saving to {}'.format(minl, mvalid_loss, args.save + args.data.split('/')[-1]))
            torch.save(engine.model.state_dict(), args.save + args.data.split('/')[-1])
            minl = mvalid_loss
