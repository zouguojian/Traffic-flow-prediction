...
args.add_argument('--dataset_dir',
                  type=str,
                  default='data/YINCHUAN',
                  help='data path')
args.add_argument('--device', type=str, default='cuda:2', help='')
...
log_dir = os.path.join(current_dir, 'experiments', args.dataset)
...
if args.mode == 'train':
    ...
    model.load_state_dict(
        torch.load(log_dir+'/best_model.pth'))
