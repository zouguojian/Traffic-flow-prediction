...
python dcrnn_demo_pytorch.py --config_filename=data/model/dcrnn_la.yaml

# YINCHUAN
python dcrnn_train_pytorch.py --config_filename=data/model/dcrnn_yc.yaml

python dcrnn_demo_pytorch.py --config_filename=data/model/dcrnn_yc.yaml
