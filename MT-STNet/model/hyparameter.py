...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/STNet_3/', help='save path')
        self.parser.add_argument('--model_name', type=str, default='STNet_3', help='training or testing model name')
